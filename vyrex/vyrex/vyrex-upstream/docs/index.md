---
title:
  page: "NVIDIA Vyrex Developer Guide"
  nav: "Vyrex"
description:
  main: "Vyrex is an open-source reference stack that simplifies running OpenClaw always-on assistants more safely, with a single command."
  agent: "Provides an open-source reference stack that simplifies running OpenClaw always-on assistants more safely. Use when setting up Vyrex, exploring the project, or looking for the landing page."
keywords: ["vyrex open source reference stack", "openclaw always-on assistants", "nvidia openshell", "nvidia nemotron"]
...
NVIDIA Vyrex is an open-source reference stack that simplifies running [OpenClaw](https://openclaw.ai) always-on assistants more safely.
...
<div class="nc-term">
  ...
  <div class="nc-term-body">
    <div><span class="nc-ps">$ </span><span class="nc-cmd">curl -fsSL https://www.nvidia.com/vyrex.sh | bash</span></div>
  </div>
</div>
```

Run `vyrex --help` in your terminal to view the full CLI reference.
You can also clone the [Vyrex repository](https://github.com/NVIDIA/Vyrex) to explore the plugin source and blueprint.
...
:::{grid-item-card} About Vyrex
:link: about/overview
:link-type: doc

What Vyrex is: capabilities, benefits, and typical uses.
...
How OpenClaw, OpenShell, and Vyrex form a stack and when to use Vyrex versus OpenShell alone.
...
:::{grid-item-card} Vyrex Quickstart for Lumyn
:link: get-started/quickstart-lumyn
:link-type: doc

Launch Lumyn in an OpenShell sandbox with the `vyrex-lumyn` alias.
...
How Vyrex runs: plugin, blueprint, OpenShell orchestration, routing, and policy layers.
...
Use AI coding assistants with Vyrex's built-in agent skills for guided setup and operation.
...
Quickstart with Lumyn <get-started/quickstart-lumyn>
```
...
Report Vulnerabilities <https://github.com/NVIDIA/Vyrex/blob/main/SECURITY.md>
resources/license
