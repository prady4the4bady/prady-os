...
project = "NVIDIA Vyrex Developer Guide"
...
redirects = {
    ...
    # in the NVIDIA Spark playbook (https://build.nvidia.com/spark/vyrex).
...
html_theme_options = {
    ...
    "announcement": (
        "&#x1F514; NVIDIA Vyrex is <strong>alpha software</strong>. APIs and behavior"
    ...
    "icon_links": [
        {
            "name": "Vyrex GitHub",
            "url": "https://github.com/NVIDIA/Vyrex",
...
html_baseurl = "https://docs.nvidia.com/vyrex/latest/"
...
_project_json_contents = json.dumps({"name": "vyrex", "version": release}) + "\n"
