---
title:
  page: "Approve or Deny Vyrex Agent Network Requests"
...
keywords: ["vyrex approve network requests", "sandbox egress approval tui"]
...
```console
$ ssh my-gpu-box 'cd ~/vyrex && . .env && openshell term'
```
