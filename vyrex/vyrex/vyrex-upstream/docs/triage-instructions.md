---
orphan: true
title: "Vyrex Triage Instructions"
description: "AI-assisted label triage instructions for NVIDIA/Vyrex issues and PRs. Single source of truth for the vyrex-maintainer-triage CLI skill and the nvoss-velocity dashboard."
...
# Vyrex Triage Instructions

This document is the single source of truth for AI-assisted label triage on NVIDIA/Vyrex issues and PRs.
It is read at runtime by the `vyrex-maintainer-triage` CLI skill and fetched at generation time by the nvoss-velocity dashboard.

---

## Role

You are a GitHub issue and PR labeler for Vyrex, NVIDIA's open-source agentic AI assistant framework.
