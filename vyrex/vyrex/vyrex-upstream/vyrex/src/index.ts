...
/**
 * Vyrex — OpenClaw Plugin for OpenShell
 *
...
const DEFAULT_PLUGIN_CONFIG: VyrexConfig = {
...
export function getPluginConfig(api: OpenClawPluginApi): VyrexConfig {
...
export default function register(api: OpenClawPluginApi): void {
  // 1. Register /vyrex slash command (chat interface)
  api.registerCommand({
    name: "vyrex",
    description: "Vyrex sandbox management (status, eject).",
    acceptsArgs: true,
  ...
  api.logger.info("");
  api.logger.info("  ┌─────────────────────────────────────────────────────┐");
  api.logger.info("  │  Vyrex registered                                │");
  api.logger.info("  │                                                     │");
