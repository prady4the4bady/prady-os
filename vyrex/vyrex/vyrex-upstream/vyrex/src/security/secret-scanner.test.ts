...
describe("scanForSecrets", () => {
  ...
  describe("does not false-positive on safe content", () => {
    ...
    it("URLs with path segments", () => {
      expect(scanForSecrets("https://github.com/NVIDIA/Vyrex/pull/1121")).toHaveLength(0);
    });
...
describe("isMemoryPath", () => {
  ...
  it("matches .vyrex paths", () => {
    expect(isMemoryPath("/sandbox/.vyrex/config.json")).toBe(true);
  });
