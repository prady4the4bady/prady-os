...
let configDir = join(homedir(), ".vyrex");
...
export interface VyrexOnboardConfig {
...
function isOnboardConfig(value: OnboardConfigSource | null): value is VyrexOnboardConfig {
  return (
    isRecord(value) &&
...
export function describeOnboardEndpoint(config: VyrexOnboardConfig): string {
...
export function describeOnboardProvider(config: VyrexOnboardConfig): string {
...
export function loadOnboardConfig(): VyrexOnboardConfig | null {
  ensureConfigDir();
...
export function saveOnboardConfig(config: VyrexOnboardConfig): void {
  ensureConfigDir();
