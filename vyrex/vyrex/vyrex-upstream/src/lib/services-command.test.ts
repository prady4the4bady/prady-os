...
describe("services command", () => {
  ...
  beforeEach(() => {
    savedEnv = {
      VYREX_SANDBOX_NAME: process.env.VYREX_SANDBOX_NAME,
      VYREX_SANDBOX: process.env.VYREX_SANDBOX,
  ...
  it("prefers VYREX_SANDBOX_NAME env var over registry default", () => {
    process.env.VYREX_SANDBOX_NAME = "env-sandbox";
    expect(resolveDefaultSandboxName(() => ({ defaultSandbox: "registry-sandbox" }))).toBe("env-sandbox");
  });

  it("prefers VYREX_SANDBOX env var over registry default", () => {
    process.env.VYREX_SANDBOX = "env-sandbox-2";
