...
/** OpenShell gateway port (default 8080, override via VYREX_GATEWAY_PORT). */
export const GATEWAY_PORT = parsePort("VYREX_GATEWAY_PORT", 8080);
/**
 ...
 * configured via VYREX_DASHBOARD_PORT at onboard time. This constant represents
 * the hardcoded default when no override is set.
 */
const SANDBOX_DASHBOARD_PORT = 18789;
/** Dashboard UI port (default SANDBOX_DASHBOARD_PORT, override via VYREX_DASHBOARD_PORT). This is the host-side port. */
export const DASHBOARD_PORT = parsePort("VYREX_DASHBOARD_PORT", SANDBOX_DASHBOARD_PORT);
...
/** vLLM / NIM inference port (default 8000, override via VYREX_VLLM_PORT). */
export const VLLM_PORT = parsePort("VYREX_VLLM_PORT", 8000);
/** Ollama inference port (default 11434, override via VYREX_OLLAMA_PORT). */
export const OLLAMA_PORT = parsePort("VYREX_OLLAMA_PORT", 11434);
/** Ollama auth proxy port (default 11435, override via VYREX_OLLAMA_PROXY_PORT). */
export const OLLAMA_PROXY_PORT = parsePort("VYREX_OLLAMA_PROXY_PORT", 11435);
