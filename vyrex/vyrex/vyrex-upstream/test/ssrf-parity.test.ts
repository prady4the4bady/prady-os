...
// (vyrex/src/blueprint/private-networks.ts) both load their rules
// from the shared vyrex-blueprint/private-networks.yaml, so a single
...
// and `npm run build` inside vyrex/ for the plugin side.
...
const pluginHelper = loadHelper(
  "../vyrex/dist/blueprint/private-networks.js",
  "`npm run build` inside vyrex/",
);
