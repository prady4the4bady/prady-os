...
# Node.js, openshell, Vyrex, and onboard setup automatically.
#
# Prerequisites:
#   - Docker running
...
#   VYREX_SANDBOX_NAME                  — sandbox name (default: e2e-nightly)
...
#
# Usage:
#   VYREX_NON_INTERACTIVE=1 VYREX_ACCEPT_THIRD_PARTY_SOFTWARE=1 NVIDIA_API_KEY=nvapi-... bash test/e2e/test-full-e2e.sh
#
# See: https://github.com/NVIDIA/Vyrex/issues/71
...
SANDBOX_NAME="${VYREX_SANDBOX_NAME:-e2e-nightly}"
...
# ══════════════════════════════════════════════════════════════════
# Phase 2: Install vyrex (non-interactive mode)
# ══════════════════════════════════════════════════════════════════
section "Phase 2: Install vyrex (non-interactive mode)"
...
info "This installs Node.js, openshell, Vyrex, and runs onboard."
...
# mediated assertion. (Vyrex #2490 / openclaw 2026.4.9 SSRF regression
...
# ══════════════════════════════════════════════════════════════════
# Phase 5: Vyrex CLI operations
# ══════════════════════════════════════════════════════════════════
section "Phase 5: Vyrex CLI operations"
...
# Vyrex tests only that its onboard correctly *configured* the policies
