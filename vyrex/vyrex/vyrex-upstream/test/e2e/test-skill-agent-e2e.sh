...
#
# Environment:
#   VYREX_SANDBOX_NAME                   — sandbox name (default: e2e-skill-agent)
...
SANDBOX_NAME="${VYREX_SANDBOX_NAME:-e2e-skill-agent}"
...
INSTALL_LOG="/tmp/vyrex-e2e-skill-agent-install.log"
