...
#   CLOUD_EXPERIMENTAL_MODEL or VYREX_CLOUD_EXPERIMENTAL_MODEL / VYREX_SCENARIO_A_MODEL
...
CLOUD_EXPERIMENTAL_MODEL="${CLOUD_EXPERIMENTAL_MODEL:-${VYREX_CLOUD_EXPERIMENTAL_MODEL:-${VYREX_SCENARIO_A_MODEL:-nvidia/nemotron-3-super-120b-a12b}}}"
