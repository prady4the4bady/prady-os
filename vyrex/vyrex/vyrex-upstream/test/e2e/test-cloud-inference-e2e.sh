...
#
# Environment:
#   VYREX_SANDBOX_NAME                   — sandbox name (default: e2e-cloud-inference)
...
#   VYREX_CLOUD_EXPERIMENTAL_MODEL      — cloud model (default: nvidia/nemotron-3-super-120b-a12b)
#
# Usage:
#   VYREX_NON_INTERACTIVE=1 VYREX_ACCEPT_THIRD_PARTY_SOFTWARE=1 \
...
SANDBOX_NAME="${VYREX_SANDBOX_NAME:-e2e-cloud-inference}"
...
info "Installing Vyrex via install.sh --non-interactive..."
INSTALL_LOG="/tmp/vyrex-e2e-cloud-inference-install.log"
