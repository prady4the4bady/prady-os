...
#
# Usage:
#   VYREX_NON_INTERACTIVE=1 VYREX_ACCEPT_THIRD_PARTY_SOFTWARE=1 NVIDIA_API_KEY=nvapi-... bash test/e2e/test-telegram-injection.sh
#
# See: https://github.com/NVIDIA/Vyrex/issues/118
#      https://github.com/NVIDIA/Vyrex/pull/119
...
# same mechanism as the Telegram bridge (SSH + vyrex-start).
#
...
MARKER_FILE="/tmp/vyrex-injection-t1-$(date +%s)"
