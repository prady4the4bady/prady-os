...
describe("blueprint.schema.json", () => {
  ...
  const data = loadYAML(repoPath("vyrex-blueprint/blueprint.yaml"));
...
describe("sandbox-policy.schema.json", () => {
  ...
  const data = loadYAML(repoPath("vyrex-blueprint/policies/openclaw-sandbox.yaml"));
...
describe("policy-preset.schema.json", () => {
  ...
  const presetsDir = repoPath("vyrex-blueprint/policies/presets");
...
describe("openclaw-plugin.schema.json", () => {
  ...
  const data = loadJSON(repoPath("vyrex/openclaw.plugin.json"));
