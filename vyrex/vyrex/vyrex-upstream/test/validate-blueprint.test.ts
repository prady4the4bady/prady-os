...
const BLUEPRINT_PATH = new URL("../vyrex-blueprint/blueprint.yaml", import.meta.url);
const BASE_POLICY_PATH = new URL(
  "../vyrex-blueprint/policies/openclaw-sandbox.yaml",
  import.meta.url,
);
...
describe("github preset", () => {
  ...
  const PRESET_PATH = new URL(
    "../vyrex-blueprint/policies/presets/github.yaml",
    import.meta.url,
  );
...
describe("huggingface preset", () => {
  ...
  const HUGGINGFACE_PRESET_PATH = new URL(
    "../vyrex-blueprint/policies/presets/huggingface.yaml",
    import.meta.url,
  );
