...
- `cli-launcher` — shebang wrapper for `bin/vyrex.js`

## Notes

- Test renames and runtime moves prepend `// @ts-nocheck` and otherwise preserve file content as much as possible.
