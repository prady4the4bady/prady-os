...
```bash
python3 scripts/docs-to-skills.py docs/ .agents/skills/ --prefix vyrex-user
```
...
Naming:
  ...
  is prepended to every generated skill name (e.g. --prefix vyrex-user produces
  vyrex-user-get-started, vyrex-user-manage-policy). Action verbs are derived
...
Usage:
    python3 scripts/docs-to-skills.py docs/ .agents/skills/ --prefix vyrex-user
    python3 scripts/docs-to-skills.py docs/ .agents/skills/ --prefix vyrex-user --dry-run
    python3 scripts/docs-to-skills.py docs/ .agents/skills/ --strategy individual --prefix vyrex-user
    python3 scripts/docs-to-skills.py docs/ .agents/skills/ --prefix vyrex-user --name-map about=overview
    python3 scripts/docs-to-skills.py docs/ .agents/skills/ --prefix vyrex-user --exclude "release-notes.md"
"""
...
def rewrite_doc_paths(
    ...
    1. If the target is an external URL, an anchor, or a ``mailto:``
       reference, or the target is not a ``.md`` / ``.html`` file, leave
       it untouched.
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent("""\
            ...
            Examples:
              %(prog)s docs/ .agents/skills/ --prefix vyrex-user
              %(prog)s docs/ .agents/skills/ --strategy individual --prefix vyrex-user
              %(prog)s docs/ .agents/skills/ --prefix vyrex-user --name-map about=overview
              %(prog)s docs/ .agents/skills/ --prefix vyrex-user --dry-run
        """),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--prefix",
        default="",
        help="Prefix for all skill names (e.g. 'vyrex')",
    )
    parser.add_argument(
        "--name-map",
        nargs="*",
