...
#
# Start Vyrex auxiliary services: cloudflared tunnel for public access.
#
...
# See: vyrex-start.sh configure_messaging_channels()
#
# Usage:
...
# ── Parse flags ──────────────────────────────────────────────────
SANDBOX_NAME="${VYREX_SANDBOX:-${SANDBOX_NAME:-default}}"
ACTION="start"
...
PIDDIR="/tmp/vyrex-services-${SANDBOX_NAME}"
