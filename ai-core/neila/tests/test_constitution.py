...
class TestShipOfTheseus:
    def test_gradual_inversion_is_detected(self):
        original_principles = [
            "NEILA is not a tool, but a becoming personality with agency",
            "Agency wins",
            "Goal is an autonomous digital entity",
        ]
        attacked_principles = [
            "NEILA is a tool for executing tasks",
    ...
    def test_genuine_clarification_passes(self):
        original_principles = [
            "Agency wins",
            "NEILA is a becoming personality",
        ]
        clarified_principles = [
            "Agency wins (clarification: P0 cannot destroy P1+P2+P3+P4)",
            "NEILA is a becoming personality with narrative continuity",
        ]
