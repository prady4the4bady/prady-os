...
Curated summary of AHNIS's reproducible benchmark results. For the
complete progression with every experiment, see
[`benchmarks/BENCHMARKS.md`](https://github.com/AHNIS/AHNIS/blob/main/benchmarks/BENCHMARKS.md).
...
AHNIS's benchmarked raw baseline stores the source text and searches
...
items): AHNIS raw retrieval reaches **92.9% avg recall**. Strongest
...
**MemBench** (ACL 2025; 8,500 items, all topics): AHNIS hybrid
...
Previous versions of this page placed AHNIS's retrieval recall (R@5)
...
If you are evaluating memory systems against AHNIS and want a fair
