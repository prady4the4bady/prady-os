...
AHNIS includes a temporal entity-relationship graph — like Zep's Graphiti, but SQLite instead of Neo4j. Local and free.
...
| Tool | Description |
|------|-------------|
| `AHNIS_kg_query` | Query entity relationships with time filtering |
...
Database location: `~/.AHNIS/knowledge_graph.sqlite3`

## Related Work

Temporal entity-relationship graphs are a familiar pattern — Zep's
Graphiti, for example, also exposes a bi-temporal model. AHNIS's
