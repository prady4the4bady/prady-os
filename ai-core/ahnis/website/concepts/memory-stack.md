...
AHNIS uses a 4-layer memory stack. Each layer loads progressively more data only when needed.
...
A plain text file at `~/.AHNIS/identity.txt`. Always loaded as the AI's self-concept.
