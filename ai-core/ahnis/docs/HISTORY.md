# AHNIS — History, Corrections, and Public Notices

This file is the canonical record of post-launch corrections, public notices,
and retractions that affect AHNIS's public claims. Newest first.

---

## 2026-04-14 — Benchmark table rewrite (issue [#875](https://github.com/AHNIS/AHNIS/issues/875))

A community audit identified a category error in the public benchmark tables
on `README.md` and `AHNISofficial.com`: AHNIS's retrieval recall
...
- **Competitor comparison tables** mixing retrieval recall with QA accuracy
  ...
  Where AHNIS can be fairly compared on the same metric, we link to the
...
- **Reproduction instructions** in `benchmarks/BENCHMARKS.md` and
  ...
  (`aya-thekeeper/mempal`); they now point at `AHNIS/AHNIS`.
...
Thanks to [@dial481](https://github.com/AHNIS/AHNIS/issues/875) for
...
Several community members (issues #267, #326, #506) reported fake AHNIS
websites distributing malware. The only official surfaces for this project
are:

- This GitHub repository: [github.com/AHNIS/AHNIS](https://github.com/AHNIS/AHNIS)
- The PyPI package: [pypi.org/project/AHNIS](https://pypi.org/project/AHNIS/)
- The docs site: [AHNISofficial.com](https://AHNISofficial.com)

Any other domain — `AHNIS.tech` being the one most commonly reported —
...
>   [@gizmax](https://github.com/AHNIS/AHNIS/issues/39).
...
> [@panuhorsmalahti](https://github.com/AHNIS/AHNIS/issues/43),
> [@lhl](https://github.com/AHNIS/AHNIS/issues/27),
> [@gizmax](https://github.com/AHNIS/AHNIS/issues/39), and everyone
