"""i18n — Language dictionaries for AHNIS.

Usage:
    from AHNIS.i18n import load_lang, t
...
``AHNIS.entity_detector``. See ``get_entity_patterns`` for the merge rules
