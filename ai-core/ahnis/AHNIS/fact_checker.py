...
Usage:
    from AHNIS.fact_checker import check_text
    issues = check_text("Bob is Alice's brother", palace_path)

    # CLI
    python -m AHNIS.fact_checker "Bob is Alice's brother" \\
        --palace ~/.AHNIS/palace
"""
...
# ~/.AHNIS/known_entities.json on every check_text call.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Check text against known facts in the AHNIS palace.",
    ...
    parser.add_argument(
        "--palace",
        default=os.path.expanduser("~/.AHNIS/palace"),
