...
AHNIS follows semantic versioning. Security fixes land on the current major version line.
...
We take the security of AHNIS seriously. If you believe you have found a security vulnerability, please report it privately using **GitHub Private Vulnerability Reporting**:

1. Open the [Security tab](https://github.com/AHNIS/AHNIS/security) of this repository.
