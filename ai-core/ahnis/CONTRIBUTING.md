# Contributing to AHNIS

Thanks for wanting to help. AHNIS is open source and we welcome contributions of all sizes — from typo fixes to new features.

## Getting Started

```bash
# Fork the repo on GitHub first, then clone your fork
git clone https://github.com/<your-username>/AHNIS.git
cd AHNIS
git remote add upstream https://github.com/AHNIS/AHNIS.git
...
```
AHNIS/          ← core package (see AHNIS/README.md for module guide)
...
Check the [Issues](https://github.com/AHNIS/AHNIS/issues) tab. Great starting points:
