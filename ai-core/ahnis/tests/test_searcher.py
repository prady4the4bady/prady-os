...
from AHNIS.searcher import SearchError, search, search_memories
...
class TestSearchMemories:
    ...
    def test_created_at_fallback_when_filed_at_missing(self):
        ...
        with patch("AHNIS.searcher.get_collection", return_value=mock_col):
    ...
    def test_search_memories_handles_none_metadata(self):
        ...
        with patch("AHNIS.searcher.get_collection", side_effect=mock_get_collection):
...
class TestBM25NoneSafety:
    ...
    Trace from the daemon log (2026-04-24 21:07:05):
        File "AHNIS/searcher.py", line 81, in _bm25_scores
            tokenized = [_tokenize(d) for d in documents]
        File "AHNIS/searcher.py", line 52, in _tokenize
            return _TOKEN_RE.findall(text.lower())
        AttributeError: 'NoneType' object has no attribute 'lower'
    """

    def test_tokenize_handles_none(self):
        from AHNIS.searcher import _tokenize
    ...
    def test_bm25_scores_does_not_crash_on_none_documents(self):
        ...
        from AHNIS.searcher import _bm25_scores
...
class TestSearchCLI:
    ...
    def test_search_warns_when_palace_uses_wrong_distance_metric(self, capsys):
        ...
        the user and point them at `AHNIS repair` rather than
        ...
        captured = capsys.readouterr()
        assert "AHNIS repair" in captured.err
    ...
    def test_search_does_not_warn_when_palace_is_correctly_configured(self, capsys):
        ...
        with patch("AHNIS.searcher.get_collection", return_value=mock_col):
            search("anything", "/fake/path")
        captured = capsys.readouterr()
        assert "AHNIS repair" not in captured.err
