...
from AHNIS.i18n import load_lang, t, available_languages
...
def test_direct_address_key_is_singular_string_for_all_locales():
    ...
    The loader at ``AHNIS/i18n/__init__.py:209-210`` only reads the singular key;
    ...
    """
    from AHNIS.i18n import _load_entity_section, available_languages
