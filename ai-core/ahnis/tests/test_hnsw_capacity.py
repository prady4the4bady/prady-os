...
from AHNIS.searcher import _bm25_only_via_sqlite


COLLECTION = "AHNIS_drawers"
...
def test_repair_status_reports_diverged(tmp_path, capsys):
    ...
    from AHNIS.repair import status as repair_status
    ...
    assert "AHNIS repair`" in captured
