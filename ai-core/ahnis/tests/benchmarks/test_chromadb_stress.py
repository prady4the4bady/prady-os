...
Tests the raw ChromaDB patterns used by AHNIS to determine:
...
class TestBulkInsertPerformance:
    ...
    def test_sequential_vs_batched(self, tmp_path):
        ...
        col_seq = client_seq.get_or_create_collection("AHNIS_drawers")
        ...
        col_batch = client_batch.get_or_create_collection("AHNIS_drawers")
