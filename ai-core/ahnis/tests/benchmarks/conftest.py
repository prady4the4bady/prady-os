...
def config_dir(tmp_path):
    """Isolated config directory for monkeypatching AHNISConfig."""
    d = tmp_path / "config"
    d.mkdir()
    config = {"palace_path": str(tmp_path / "palace"), "collection_name": "AHNIS_drawers"}
...
def pytest_terminal_summary(terminalreporter, config):
    ...
    results_file = os.path.join(tempfile.gettempdir(), "AHNIS_bench_results.json")
