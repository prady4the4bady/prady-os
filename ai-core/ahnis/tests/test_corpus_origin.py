...
TDD: these tests fail until AHNIS/corpus_origin.py is implemented."""

from AHNIS.corpus_origin import (
    CorpusOriginResult,
...
class TestHeuristic:
    ...
    def test_brand_terms_case_insensitive(self):
        ...
        samples = [
            ...
            "added AHNIS as an mcp server in my .claude/ settings file",
...
class _FakeProvider:
    """Minimal stand-in for AHNIS's LLMProvider used for testing."""
