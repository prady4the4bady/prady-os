"""Tests for AHNIS.dedup — near-duplicate drawer detection and removal."""

from unittest.mock import MagicMock, patch


from AHNIS import dedup
...
@patch("AHNIS.dedup.ChromaBackend")
...
@patch("AHNIS.dedup.dedup_source_group")
@patch("AHNIS.dedup.get_source_groups")
@patch("AHNIS.dedup.ChromaBackend")
