...
``AHNIS.backends`` entry point::

    # pyproject.toml of AHNIS-postgres
    [project.entry-points."AHNIS.backends"]
    postgres = "AHNIS_postgres:PostgresBackend"

AHNIS discovers them at process start. In-tree tests and local development
...
_ENTRY_POINT_GROUP = "AHNIS.backends"
