"""Source adapter contract for AHNIS (RFC 002).

Mirrors what ``AHNIS/backends/base.py`` does for the write side: it defines
...
This module is spec scaffolding. The first-party miners (``AHNIS/miner.py``
and ``AHNIS/convo_miner.py``) are migrated onto it in a follow-up PR;
